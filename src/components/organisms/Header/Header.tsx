    ...
    <header className={`${styles.header} ${bgColorClass}`}>
      ...
      <div className={styles["header_menu"]}>
        <nav className={styles["header_nav"]}>
          ...
          <div className={styles["header_nav_item"]}>
            <Link className={`${styles["header_nav_link"]} ${styles["--right-border"]}`} href="/spaces">
              Download App
            </Link>
          </div>
          <div className={`${styles["header_nav_item"]} ${styles["is-header-pc"]}`}>
            <button className={styles["header_dropdown_parent"]}>
              <IconBase
                iconName="earth"
                className={styles["icon-earth"]}
            ...
            <div className={`${styles["header_dropdown"]} ${styles["is-open"]}  ${bgColorClass}`}>
